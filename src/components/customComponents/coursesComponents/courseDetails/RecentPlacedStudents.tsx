...
export function RecentPlacedStudents() {
  ...
  return (
    <div className="flex items-center justify-center h-screen w-full px-4">
      <div className="w-full relative rounded-3xl overflow-hidden max-w-md mx-auto bg-gradient-to-r from-[#520000] to-[#710000] p-8 my-10">
        <Rays />
        <Beams />
        <div className="relative z-10">
          <Lens hovering={hovering} setHovering={setHovering}>
            <Image
              src="https://media.licdn.com/dms/image/v2/D5622AQHZV4xvucqUXQ/feedshare-shrink_1280/B56ZRQe.TtH0Ak-/0/1736517085374?e=1739404800&v=beta&t=F0tRd8G9Mm5R9K08L5_OxGpX5kioqnfGtQJN5ps1ehA"
              alt="image"
              width={600}
              height={500}
...
46+ students shortlisted for Signzy as DevOps Engineer - Freshers 2024-2025 passouts from our previous DevOps batch
  ...
  return (
    ...
    >
      <g filter="url(#filter0_f_120_7473)">
        <circle cx="34" cy="52" r="114" fill="#a50000" />
      </g>
      <g filter="url(#filter1_f_120_7473)">
        <circle cx="332" cy="24" r="102" fill="#ce0000" />
      </g>
