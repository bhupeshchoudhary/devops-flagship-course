...
export default function TestimonialsSection() {
  ...
  return (
    <section className="relative bg-[#faf7f4] overflow-hidden p-12">
      <div className="container mx-auto px-4 py-20 grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Left Section */}
        <section className="relative lg:col-span-1 order-2 lg:order-1" aria-hidden="true">
        ...
        {/* Right Section */}
        <section className="relative z-10 lg:col-span-1 order-1 lg:order-2">
