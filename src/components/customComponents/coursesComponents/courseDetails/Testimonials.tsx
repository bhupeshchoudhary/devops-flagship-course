...
const floatingAvatars = [
  ...
  { top: "34%", left: "14%", size: 50, delay: 20, image: "/assets/learnersSayImages/PrateekSrivastava.png" },
  { top: "24%", left: "71%", size: 50, delay: 20, image: "/assets/learnersSayImages/ShubhamKumar.png" },
  { top: "74%", left: "66%", size: 50, delay: 20, image: "/assets/learnersSayImages/UtkarshKumarSingh.png" },
