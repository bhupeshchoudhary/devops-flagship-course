...
//               {/* First Card */}
//               <Card className="bg-re border-none shadow-lg w-full">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="container px-4 md:px-12 max-w-5xl mx-auto bg-gradient-to-r from-[#520000] via-[#710000] via-[#a50000] to-[#ce0000] pb-6 rounded-xl relative">
          ...
          <div className="pt-6 pl-4 md:pl-16">
            ...
            <div className="md:hidden flex flex-col gap-4">
              ...
              <Card className="bg-gradient-to-r from-[#520000] to-[#ce0000] border-none shadow-lg w-full">
                <CardContent className="p-4 flex flex-col items-center text-center">
                  ...
                  <p className="text-white text-sm">(Note : 100% refund if not hired*)</p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="hidden md:flex flex-row items-center justify-center gap-4 md:gap-6 mt-8 md:-ml-12 lg:-ml-12">
              {/* First Card */}
              <Card className="bg-red-2000 border-none shadow-lg hover:shadow-xl transition-shadow w-64">
                <CardContent className="p-4 md:p-6 flex flex-col items-center text-center">
                  <div className="w-full h-36 md:h-28 relative md:mb-8 lg:mb-8">
                    <div className="absolute inset-0 rounded-lg p-4">
                      <div className="mb">
                  ...
                  <h3 className="text-white font-base text-sm">Apply Now & Start Your Learning Journey</h3>
                </CardContent>
              </Card>
              ...
              {/* Second Card */}
              <Card className="bg-red-1400 border-none shadow-lg hover:shadow-xl transition-shadow w-64">
                <CardContent className="p-4 md:p-6 flex flex-col items-center text-center">
                  <div className="w-full h-36 md:h-28 relative mb-4">
                    <div className="absolute inset-0 rounded-lg p-4">
                      <img src="/assets/project.png" alt="image" className="w-full h-full object-contain" />
                  ...
                  <h3 className="text-white font-base text-sm">Build Your 20+ CapStone Industry Level Projects</h3>
                </CardContent>
              </Card>
              ...
              {/* Third Card */}
              <Card className=" bg-red-1300 border-none shadow-lg hover:shadow-xl transition-shadow w-64">
                <CardContent className="p-4 md:p-6 flex flex-col items-center text-center">
                  <div className="w-full h-36 md:h-28 relative mb-4">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <img src="/assets/Business-Communication.png" alt="img" className="w-full h-full object-contain" />
                  ...
                  <h3 className="text-white font-base text-sm">Business Communication & Assessments</h3>
                </CardContent>
              </Card>
              ...
              {/* Fourth Card */}
              <Card className=" bg-red-1200 border-none shadow-lg hover:shadow-xl transition-shadow w-64">
                <CardContent className="p-4 md:p-6 flex flex-col items-center text-center">
                  <div className="w-full h-36 md:h-28 relative mb-4">
                    <div className="absolute inset-0 rounded-lg p-4 flex items-center justify-center">
                      <img src="/assets/Get-placed.png" alt="img" className="w-full h-full object-contain" />
                  ...
                  <h3 className="text-white font-base text-sm">Get placed as DevOps Engineer</h3>
                  <p className="text-white text-xs">(Note : 100% refund if not hired*)</p>
                </CardContent>
              </Card>
            </div>
          </div>
